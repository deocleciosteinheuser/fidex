...
class ConsultaClienteController extends ConsultaController
{
    protected function getConsulta()
    {
        return parent::getConsulta()->setAgrupador(ConsultaAgrupador::CLIENTE);
    }
